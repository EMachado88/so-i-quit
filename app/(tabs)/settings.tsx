      ...
      <ThemedView>
        ...
        >
          <ThemedView style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            >
              {soberDate
                ? new Date(soberDate).toLocaleDateString()
                : "--/--/----"}
            </Button>
          </ThemedView>
          <ThemedView style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        >
          ...
          <Button
            ...
            onPress={() => {
              Alert.alert(
                "Reset Sober Date",
                "Are you sure you want to reset your sober date?",
                [
                  {
                    text: "Cancel",
                    style: "cancel",
      ...
      <ThemedView>
        ...
        >
          <ThemedView style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            >
              {smokeDate
                ? new Date(smokeDate).toLocaleDateString()
                : "--/--/----"}
            </Button>
          </ThemedView>
          <ThemedView style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        >
          ...
          <Button
            ...
            onPress={() => {
              Alert.alert(
                "Reset Smoke Date",
                "Are you sure you want to reset your smoke free date?",
                [
                  {
                    text: "Cancel",
                    style: "cancel",
